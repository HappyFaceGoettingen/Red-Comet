...
class GridFtpCopyViewer(hf.module.ModuleBase):
    ...
    def extractData(self):        
        ...
        # Result of the transfers from Site2 to Site1      
    ...
    def getTemplateData(self):        
        ...
        self.dataset['error_status'] = ['Failed', 'Error', 'No match', 'Permission denied', 'Cannot create a directory', 'Remote server has disconnected', 'Transfer in progress', 'timeout', 'is not a directory']
        self.dataset['error_status_prod_data'] = ['OK', 'SpaceException', 'FileExists', 'Cannot create a directory', 'Remote server has disconnected', 'Transfer in progress', 'timeout']
